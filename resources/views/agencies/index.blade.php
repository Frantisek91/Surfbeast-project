        ...
        <div class="accordion" id="accordionExample">
            ...
            <div id="collapse{{$agency->id}}" class="collapse hide" aria-labelledby="heading{{$agency->id}}}" data-parent="#accordionExample">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        @can("admin")
                        <a href="{{action("AgencyController@edit", $agency->id)}}" class = "btn btn-success mx-1">Upravit</a>
                        <a href="{{ action("AgencyController@show", $agency->id) }}" class="btn btn-primary mx-1">Náhled</a>
